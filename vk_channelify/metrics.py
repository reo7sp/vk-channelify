...
repost_iterations_total = Counter('vk_channelify_repost_iterations_total', 'Total number of repost worker iterations')
...
repost_posts_sent_total = Counter(
    'vk_channelify_posts_sent_total', 'Total number of posts sent to Telegram channels', ['channel_id', 'vk_group_id']
)
...
vk_api_requests_total = Counter(
    'vk_channelify_vk_api_requests_total', 'Total number of VK API requests', ['method', 'status', 'vk_group_id']
)
...
channels_disabled_total = Counter(
    'vk_channelify_channels_disabled_total', 'Total number of channels disabled', ['channel_id', 'vk_group_id']
)

# Channel state metrics
active_channels_gauge = Gauge('vk_channelify_active_channels', 'Current number of active channels')
disabled_channels_gauge = Gauge('vk_channelify_disabled_channels', 'Current number of disabled channels')

# Manage worker metrics
telegram_commands_total = Counter(
    'vk_channelify_telegram_commands_total', 'Total number of Telegram commands received', ['command']
)
...
telegram_conversations_total = Counter(
    'vk_channelify_telegram_conversations_total', 'Total number of Telegram conversations', ['type', 'status']
)
